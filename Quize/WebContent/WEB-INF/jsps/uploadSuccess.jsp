...
<ul>
   ...
   <li><a href='${pageContext.request.contextPath}/surveyresult'><span>Survey Result</span></a></li>
...
<h3>Congratulation ${requestScope.newSur} your survey created successfully , <a href="${pageContext.request.contextPath}/survey">survey</a> upload your survey.</h3>
</div>
